...
export default function Nav() {
  ...
  return (
    <header className="relative z-20 flex items-center justify-between px-5 sm:px-10 py-5 max-w-7xl mx-auto">
      ...
      {open && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-panel border-b border-panelborder px-5 py-6 flex flex-col gap-5">
          {navLinks.map((l) => (
